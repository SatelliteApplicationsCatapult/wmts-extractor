...
class TileScraper(Thread):
    ...
    def run(self):
        ...
        for task in self._tasks:
            ...
            # get bounds
            s, w, n, e = self._tiler.tile_bounds(*(task['xyz']))
            intersects = True
            ...
            if intersects:
                ...
                # download tile
                self.get_tile(task['uri'], task['pathname'])
    ...
    def get_tile(self, uri, pathname):
                ...
                try:
                    ...
                    if self._credentials is not None:
                        curl.setopt(pycurl.USERPWD,
                                    "{}:{}".format(self._credentials['username'], self._credentials['password']))
